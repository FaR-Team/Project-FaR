...
{
    public class FaRFoldersData : ScriptableObject
    {
        ...
        [CustomEditor(typeof(FaRFoldersData))]
        class Editor : UnityEditor.Editor
        {
            public override void OnInspectorGUI()
            {
                ...
                void meta()
                {
                    ...
                    Space(10);
                    EditorGUILayout.LabelField("FaRFolders currently stores data in .meta files of folders", style);
        ...
        public static bool storeDataInMetaFiles { get => EditorPrefs.GetBool("FaRFolders-storeDataInMetaFilesEnabled", false); set => EditorPrefs.SetBool("FaRFolders-storeDataInMetaFilesEnabled", value); }
