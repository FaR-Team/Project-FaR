...
using static FaRFolders.FaRFoldersData;
using static FaRFolders.FaRFoldersCache;
...
{
    public static class FaRFolders
    {
        static void RowGUI(string guid, Rect rowRect)
        {
            ...
            var useClearerRows = FaRFoldersMenu.clearerRowsEnabled && !isListArea;
            var useMinimalMode = FaRFoldersMenu.minimalModeEnabled && !isListArea;
            var useContentMinimap = FaRFoldersMenu.contentMinimapEnabled && !isListArea;
            var useHierarchyLines = FaRFoldersMenu.hierarchyLinesEnabled && !isListArea;
            var useZebraStriping = FaRFoldersMenu.zebraStripingEnabled && !isListArea;
            ...
            void drawing()
            {
                ...
                void hoveredRow()
                {
                    if (!isRowHovered) return;
                    if (isListArea) return;
                    if (EditorWindow.mouseOverWindow == FaRFoldersPaletteWindow.instance) return;
            ...
            void altClick()
            {
                ...
                void mouseUp()
                {
                    ...
                    if (FaRFoldersPaletteWindow.instance && FaRFoldersPaletteWindow.instance.guids.SequenceEqual(guidsToEdit)) { FaRFoldersPaletteWindow.instance.Close(); return; }
                    ...
                    if (!FaRFoldersPaletteWindow.instance)
                        FaRFoldersPaletteWindow.CreateInstance(position);

                    FaRFoldersPaletteWindow.instance.Init(guidsToEdit);
                    FaRFoldersPaletteWindow.instance.Focus();

                    FaRFoldersPaletteWindow.instance.targetPosition = position;
        ...
        static void ProjectBrowserItemGUI(string guid, Rect itemRect)
        {
            ...
            {
                if (!curEvent.isLayout) return;
                if (!FaRFoldersMenu.foldersFirstEnabled) return;
        ...
        public static void DrawBigFolderIcon(Rect rect, FolderInfo folderInfo)
        {
            ...
            void assetIcon()
            {
                ...
                void material()
                {
                    ...
                    outlineMaterial = new Material(Shader.Find("Hidden/FaRFoldersOutline"));
        ...
        static void CheckShortcuts() // called from globalEventHandler
        {
            ...
            void toggleExpanded()
            {
                ...
                if (!FaRFoldersMenu.toggleExpandedEnabled) return;
            ...
            void collapseEverything()
            {
                ...
                if (!FaRFoldersMenu.collapseEverythingEnabled) return;
            ...
            void collapseEverythingElse()
            {
                ...
                if (!FaRFoldersMenu.collapseEverythingElseEnabled) return;
        ...
        public class FolderInfo
        {
            public string iconNameOrGuid
            {
                get
                {
                    ...
                    if (iconNameOrGuid == "" || iconNameOrGuid == null)
                        iconNameOrGuid = FaRFoldersMenu.autoIconsEnabled ? folderState.autoIconName : "";
                ...
                set
                {
                    if (!FaRFoldersMenu.autoIconsEnabled) { folderData.iconNameOrGuid = value; return; }
                    ...
                    // if (value == folderState.autoIconName && FaRFoldersMenu.autoIconsEnabled)
                    //     folderData.iconNameOrGuid = "";
            ...
            public Color color
            {
                get
                {
                    ...
                    // return FaRFoldersPalette.GetDefaultColor(folderData.colorIndex - 1);
            ...
            public bool hasIcon => (folderData != null && folderData.iconNameOrGuid != "" && folderData.iconNameOrGuid != "none") || (FaRFoldersMenu.autoIconsEnabled && folderState.autoIconName != "" && (folderData == null || folderData.iconNameOrGuid != "none"));
            public bool hasColor => folderData != null && folderData.colorIndex.IsInRange(1, FaRFoldersPalette.colorsCount);
        ...
        public static FolderData GetFolderData(string guid, bool createDataIfDoesntExist)
        {
            ...
            {
                if (FaRFoldersData.storeDataInMetaFiles) return;
        ...
        public static FaRFoldersCache cache => FaRFoldersCache.instance;
        ...
        static void Init()
        {
            if (FaRFoldersMenu.pluginDisabled) return;
            ...
            void loadData()
            {
                data = AssetDatabase.LoadAssetAtPath<FaRFoldersData>(EditorPrefs.GetString("FaRFolders-lastKnownDataPath-" + GetProjectId()));


                if (data) return;

                data = AssetDatabase.FindAssets("t:FaRFoldersData").Select(guid => AssetDatabase.LoadAssetAtPath<FaRFoldersData>(guid.ToPath())).FirstOrDefault();


                if (!data) return;

                EditorPrefs.SetString("FaRFolders-lastKnownDataPath-" + GetProjectId(), data.GetPath());

            }
            void loadPalette()
            {
                palette = AssetDatabase.LoadAssetAtPath<FaRFoldersPalette>(EditorPrefs.GetString("FaRFolders-lastKnownPalettePath-" + GetProjectId()));


                if (palette) return;

                palette = AssetDatabase.FindAssets("t:FaRFoldersPalette").Select(guid => AssetDatabase.LoadAssetAtPath<FaRFoldersPalette>(guid.ToPath())).FirstOrDefault();


                if (!palette) return;

                EditorPrefs.SetString("FaRFolders-lastKnownPalettePath-" + GetProjectId(), palette.GetPath());
            ...
            {
                if (!data) return;
                if (EditorPrefs.GetBool("FaRFolders-dataMigrationFromV1Attempted-" + GetProjectId(), false)) return;

                EditorPrefs.SetBool("FaRFolders-dataMigrationFromV1Attempted-" + GetProjectId(), true);
        ...
        public static FaRFoldersData data;
        public static FaRFoldersPalette palette;
