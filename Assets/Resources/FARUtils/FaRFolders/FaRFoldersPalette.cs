...
{
    public class FaRFoldersPalette : ScriptableObject
    {
        ...
        public void Export()
        {
            var packagePath = EditorUtility.SaveFilePanel("Export FaRFolders Palette", "", this.GetPath().GetFilename(withExtension: false), "unitypackage");
