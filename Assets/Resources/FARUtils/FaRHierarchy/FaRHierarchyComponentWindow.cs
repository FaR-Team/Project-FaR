...
{
    public class FaRHierarchyComponentWindow : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            void header()
            {
                ...
                void icon()
                {
                    ...
                    GUI.Label(iconRect, FaRHierarchy.GetComponentIcon(component));
        ...
        void OnDestroy()
        {
            ...
            EditorPrefs.SetFloat("FaRHierarchy-componentWindowWidth", position.width);
        ...
        {
            floatingInstance = ScriptableObject.CreateInstance<FaRHierarchyComponentWindow>();
            ...
            var savedWidth = EditorPrefs.GetFloat("FaRHierarchy-componentWindowWidth", minWidth);
        ...
        public static FaRHierarchyComponentWindow floatingInstance;
