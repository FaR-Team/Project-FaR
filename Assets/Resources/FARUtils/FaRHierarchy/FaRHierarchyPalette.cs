...
{
    public class FaRHierarchyPalette : ScriptableObject
    {
        ...
        public void Export()
        {
            var packagePath = EditorUtility.SaveFilePanel("Export FaRHierarchy Palette", "", this.GetPath().GetFilename(withExtension: false), "unitypackage");
