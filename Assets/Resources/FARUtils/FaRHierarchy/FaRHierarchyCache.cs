...
{
    [FilePath("Library/FaRHierarchy Cache.asset", FilePathAttribute.Location.ProjectFolder)]
    public class FaRHierarchyCache : ScriptableSingleton<FaRHierarchyCache>
    {
