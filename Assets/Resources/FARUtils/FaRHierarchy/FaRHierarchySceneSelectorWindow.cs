...
{
    public class FaRHierarchySceneSelectorWindow : EditorWindow
    {
        ...
        public static void Open(Vector2 rowPos, Scene sceneToReplace)
        {
            ...
            instance = ScriptableObject.CreateInstance<FaRHierarchySceneSelectorWindow>();
        ...
        public static FaRHierarchySceneSelectorWindow instance;
